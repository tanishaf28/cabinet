#!/bin/bash
# ================================================================
# HETERO-5 NETEM RATIO SWEEP + TIMELINE (CABINET): independent-ratio
...
#
# Adapted from run_hetero5_netem_i2d_cab.sh: NUM_CLIENTS 2->5 (cabinet's
...
RESULT_ROOT="${REPO_ROOT}/results/hetero5_ratio_delay_5c_b1000_cab"
...
echo "================================================================"
echo " HETERO-5 NETEM RATIO SWEEP + TIMELINE (Cabinet): ${DELAY_MS}ms ±${JITTER_MS}ms, 5 clients, batch=1000"
echo "================================================================"
...
echo ""
echo "=================================================="
echo " Hetero-5 netem ratio sweep + timeline complete (Cabinet)"
echo "=================================================="
