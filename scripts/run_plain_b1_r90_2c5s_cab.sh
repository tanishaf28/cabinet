#!/bin/bash
# ================================================================
# HETERO-5 PLAIN STEADY-STATE RUN (CABINET): NUM_SERVERS=5, NUM_CLIENTS=2,
...
RESULT_ROOT="${REPO_ROOT}/results/hetero5_plain_b1_r90_2c5s_cab"
...
echo "================================================================"
echo " HETERO-5 PLAIN STEADY-STATE RUN (Cabinet): indep=90, batch=1, maxinflight=5, 5s/2c"
echo "================================================================"
...
archive_results "plain_indep90_b1_2c5s"
...
echo ""
echo "=================================================="
echo " Hetero-5 plain steady-state run complete (Cabinet)"
echo "=================================================="
