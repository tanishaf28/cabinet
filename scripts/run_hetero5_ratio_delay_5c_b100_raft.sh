...
RESULT_ROOT="${REPO_ROOT}/results/hetero5_ratio_delay_5c_b100_raft"
...
echo "================================================================"
echo " HETERO-5 NETEM RATIO SWEEP + TIMELINE (Raft): ${DELAY_MS}ms ±${JITTER_MS}ms, 5 clients, batch=100"
echo "================================================================"
