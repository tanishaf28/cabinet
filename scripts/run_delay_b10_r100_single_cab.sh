#!/bin/bash
# ================================================================
# HETERO-5 NETEM SINGLE DELAY RUN + TIMELINE (CABINET): one steady-state
...
RESULT_ROOT="${REPO_ROOT}/results/hetero5_delay_b10_r100_single_cab"
...
echo "================================================================"
echo " HETERO-5 NETEM SINGLE DELAY RUN (Cabinet): ${DELAY_MS}ms ±${JITTER_MS}ms, indep=100, batch=10"
echo "================================================================"
...
archive_results "delay_${DELAY_MS}ms_jitter_${JITTER_MS}ms_indep100_b10"
...
echo ""
echo "=================================================="
echo " Hetero-5 netem single delay run complete (Cabinet)"
echo "=================================================="
