#!/bin/bash
# ================================================================
# HETERO-5 NETEM I2D SWEEP (CABINET): independent-ratio sweep
...
# as run_hetero_netem_cab.sh) -- THRESHOLD=1 since Cabinet's quorum
# tolerance isn't tied to n the way Raft's majority threshold is.
SERVER_IPS=(
    "192.168.73.59"
    "192.168.73.243"
    "192.168.73.192"
...
echo "================================================================"
echo " HETERO-5 NETEM I2D SWEEP (Cabinet): ${DELAY_MS}ms ±${JITTER_MS}ms (server-side only)"
echo "================================================================"
...
echo ""
echo "=================================================="
echo " Hetero-5 netem i2d sweep complete (Cabinet)"
echo "=================================================="
