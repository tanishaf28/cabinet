#!/bin/bash
# ================================================================
# HETERO-5 RATIO SWEEP (Cabinet): NUM_SERVERS=5, NUM_CLIENTS=5,
...
# run_hetero_batchsize_sweep_10c_cab.sh). THRESHOLD fixed at 1 (Cabinet
# quorum semantics) -- see run_ratio_sweep_b1_5c5s_raft.sh for Raft's
# counterpart (t=2, majority).
# ================================================================
...
RESULT_ROOT="${REPO_ROOT}/results/hetero5_ratio_sweep_b1_5c5s_cab"
...
echo "================================================================"
echo " HETERO-5 RATIO SWEEP (Cabinet): batch=1, 5s/5c"
echo "================================================================"
...
for indep in "${TEST_CASES[@]}"; do
    ...
    BASE_ENV=(
        "NUM_SERVERS=5" "NUM_CLIENTS=5" "CONFIG_PATH=${CONFIG_PATH}" "THRESHOLD=1" "OPS=0"
...
python3 "${REPO_ROOT}/extract_metrics.py" "$RUN_DIR" --system cabinet --size 5

echo ""
echo "=================================================="
echo " Hetero-5 ratio sweep complete (Cabinet)"
echo "=================================================="
