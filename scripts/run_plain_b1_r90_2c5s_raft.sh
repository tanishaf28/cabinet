#!/bin/bash
# ================================================================
# HETERO-5 PLAIN STEADY-STATE RUN (Raft): NUM_SERVERS=5, NUM_CLIENTS=2,
...
RESULT_ROOT="${REPO_ROOT}/results/hetero5_plain_b1_r90_2c5s_raft"
...
echo "================================================================"
echo " HETERO-5 PLAIN STEADY-STATE RUN (Raft): indep=90, batch=1, maxinflight=5, 5s/2c"
echo "================================================================"
